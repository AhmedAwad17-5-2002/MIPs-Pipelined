...
/*APB timer used for decremetning a value that is set in it's register and depending on configurability can or can't generate an interrupt signal internally*/
...
//Peripheral identifications registers
...
always @(PADDR or reg_ctrl or reg_reload_val or reg_timer_int or
  ...
  always @(*)
  begin
    if(write_enable & reserved_address)
      begin
        PSLVERR <= 1'b1;
      end
    else
